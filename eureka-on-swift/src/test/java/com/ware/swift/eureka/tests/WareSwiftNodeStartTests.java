...
public class WareSwiftNodeStartTests {
    ...
    public void wareSwiftStartup() throws Exception {
        WareSwiftGlobalContext wareSwiftGlobalContext = WareSwiftDeveloperManager.wareSwiftInit("ware-swift.properties");
        while (true) {
            TimeUnit.SECONDS.sleep(1);

            NodeInformation leader = wareSwiftGlobalContext.getLeader();
            if (leader == null) {
