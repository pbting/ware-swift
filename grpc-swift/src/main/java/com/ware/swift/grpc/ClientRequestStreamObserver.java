...
public class ClientRequestStreamObserver extends AbstractCallStreamObserver
     ...
     *
     * @param wareSwiftInteractive
     */
    @Override
    public void request(GrpcRequestStreamInteractive wareSwiftInteractive) {
        int eventType = wareSwiftInteractive.getInteractivePayload().getEventType();
