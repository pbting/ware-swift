 ...
 *
 */
public class NodeInformation implements Information {
	...
	public boolean isLeaderMeet() {
		return Boolean.valueOf(config.getProperty("leader.meet", "false"));
	}
	...
	public void setSdownVoteCount(AtomicLong sdownVoteCount) {
		this.sdownVoteCount = sdownVoteCount;
	}
	...
	public long incrementCommittedCount() {
		final long tmpHasCommittedCount = hasCommittedCount++;
		// System.err.println("\t\t\t committed =" + tmpHasCommittedCount);
		return tmpHasCommittedCount;
	}
	...
	public String toString() {
		return "NodeInformation{" + "votedFor='" + atomicVotedFor.get() + '\''
				+ ", voteCount=" + voteCount + ", term=" + term + ", voteForTime="
				+ voteForTime + ", nodeState=" + nodeState + ", clusterName='"
				+ clusterName + '\'' + ", bindAddress='" + bindAddress + '\''
				+ ", bindPort='" + bindPort + '\'' + ", config=" + config + '}';
	}
}
