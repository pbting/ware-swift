...
public abstract class AbstractRemotingPipelineEventListener
     ...
     */
    public void onSendAllRemotingChannels(IInteractive wareSwiftInteractive) throws Exception {

        InteractivePayload.Builder builder = InteractivePayload.newBuilder();
        builder.setSource(wareSwiftInteractive.getInteractivePayload().getSink());
        builder.setSink(wareSwiftInteractive.getInteractivePayload().getSource());
