...
public class RemotingManager implements IRemotingManager {
    ...
    private static final String LEADER_FOLLOWER_RSOCKET_REMOTING_MANAGER =
            "java.com.ware.rsocket.swift.LeaderFollowerRSocketRemotingManager";

    private static final String LEADER_FOLLOWER_GRPC_REMOTING_MANAGER = "com.ware.swift.grpc.swift.LeaderFollowerGrpcRemotingManager";
