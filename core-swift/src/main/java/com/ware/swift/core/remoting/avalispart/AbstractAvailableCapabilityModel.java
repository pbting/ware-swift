...
public abstract class AbstractAvailableCapabilityModel
    ...
    public void onOutboundDataSet(final RemotingDomainSupport remotingDomain,
        ...
        syncingSuccessChannels.add(RemotingManager.getRemotingManager().getChannelIdentify(remotingManager.getWareSwiftConfig().getNodeInformation().identify()));
                ...
                .forEach(abstractRemotingChannel -> {
                    ...
                    try {
                        ...
                        logger.error(WareSwiftExceptionCode.formatExceptionMessage(
                                WareSwiftExceptionCode.REMOTING_OUTBOUND_DATASET_ERROR_CODE,
                                e.getMessage()));
                        abstractRemotingChannel
                                .addSyncingRemotingDomain(interactivePayload);
        ...
        onAfterOutboundDataSet(remotingDomain);
    }
     ...
     * @param remotingDomain
     */
    public void onAfterOutboundDataSet(final RemotingDomainSupport remotingDomain) {
