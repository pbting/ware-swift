...
public interface OutboundCallback {
    ...
    /**
     * @param channelIdentifies 每个 remoting channel 的 identify
     */
    default void onSyncingSuccess(Set<String> channelIdentifies) {
        // nothing to do
    }
     ...
     *
     * @param successChannelIdentifies 同步成功的 remoting channel
     * @param failedChannelIdentifies  同步失败的 remoting channel
     */
    default void onSyncingFailed(Set<String> successChannelIdentifies,
    ...
    default void onReplBacklogSyncingAdd(boolean isAddSuccess, RemotingDomainSupport remotingDomainSupport) {
